export default function BannerActualizacion({ onActualizar }) {
  return (
    <div className="w-full max-w-sm flex-shrink-0 bg-white border border-slate-200 rounded-2xl shadow-2xl px-5 py-4 mb-4 flex items-center justify-between gap-4">
